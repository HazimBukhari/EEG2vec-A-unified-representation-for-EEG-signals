...
filepath = r"D:\IDL_PROJECT_DATA\CNN_Graph_ON_SMALLP300\p300-less\data"

# Ensure the path ends with a slash
df = glob.glob(os.path.join(filepath, "*.mat"))

print("Found files:", df)
...
for i in range(len(ep)):
    ep[i].save(r'D:\IDL_PROJECT_DATA\CNN_Graph_ON_SMALLP300\p300-less\epochs\A0' + str(i + 1) + '-epo.fif')
...
#Write as arrays
np.save(r'D:\IDL_PROJECT_DATA\CNN_Graph_ON_SMALLP300\p300-less\epochs\A-epo.npy', combined_epochs)
np.save(r'D:\IDL_PROJECT_DATA\CNN_Graph_ON_SMALLP300\p300-less\epochs\A-labels.npy', combined_labels)
